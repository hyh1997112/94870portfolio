...
## Initial sketches
* First, we will introduce the basic information of the project. So in this section there will be some charts showing basic statistics.
* Second, data related to employment information is presented. This part of the data is mainly from two sources, one is the official website of heinz, and the other is the employment data of OFLC.
* Finally, make a corresponding summary based on the previous chart and information.
* p.s. The data used for the sketch might not be the real data. The chart used here may not be used in the final page.
